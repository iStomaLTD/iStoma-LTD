    ...
    public partial class ControlListaCategorii : UserControlPersonalizat
    {
        ...
        private void TgvListaCategorii_StergereLinie(DataGridViewPersonalizat pDGVSender, int pIndexRand)
        {
            ...
            try
            {
                ...
                if (categorie != null)
                {
                    ...
                    {
                        categorie.Close(true, BMultiLingv.getElementById(BMultiLingv.EnumDictionar.Inchidere), null);
                        ConstruiesteRanduriTGV();
                    }
                }
            }
        ...
        private void incarcaRandCategorie(BCategorii pCategorie)
        {
            ...
            if (pCategorie != null)
            {
                ...
                TreeGridView.SeteazaCuloareFundalCelula(NodCategorie, EnumColTGV.colCuloare.ToString(), BDefinitiiGenerale.getCuloareDinARGB(pCategorie.Culoare));
