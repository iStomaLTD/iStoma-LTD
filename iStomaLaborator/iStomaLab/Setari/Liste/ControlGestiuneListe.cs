...
namespace iStomaLab.Setari.Liste
{
    public partial class ControlGestiuneListe : UserControlPersonalizat
    {
        ...
        private Setari.Liste.Tari.ControlListaTari lctrlListaTari = null;
        private Setari.Liste.Regiuni.ControlListaRegiuni lctrlListaRegiuni = null;
        ...
        private Setari.Liste.Banci.ControlListaBanci lctrlListaBanci = null;
        ...
        private void incarcaOptiuneaSelectata(CDefinitiiComune.EnumTipLista pOptiune)
        {
            ...
            if (this.lctrlListaBanci != null)
                this.lctrlListaBanci.Visible = false;
        ...
        private void initControlListaTari()
        {
            if (this.lctrlListaTari == null)
            {
                this.lctrlListaTari = new Tari.ControlListaTari();
        ...
        private void initControlListaRegiuni()
        {
            if (this.lctrlListaRegiuni == null)
            {
                this.lctrlListaRegiuni = new Regiuni.ControlListaRegiuni();
        ...
        private void initControlListaBanci()
        {
            if (this.lctrlListaBanci == null)
            {
                this.lctrlListaBanci = new Banci.ControlListaBanci();
                this.lctrlListaBanci.Name = "ctrlListaBanci";
                adaugaControlInZonaUtila(this.lctrlListaBanci);
            }

            this.lctrlListaBanci.Initializeaza();
            this.lctrlListaBanci.Visible = true;
            this.lctrlListaBanci.BringToFront();
        }
