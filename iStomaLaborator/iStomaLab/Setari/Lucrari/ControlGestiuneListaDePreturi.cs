...
namespace iStomaLab.Setari.Lucrari
{
    public partial class ControlGestiuneListaDePreturi : UserControlPersonalizat
    {
        ...
        private Setari.Lucrari.ControlListaEtape lctrlEtape = null;
        ...
        {
            this.mnuBtnPreturiStandard.Text = BMultiLingv.getElementById(BMultiLingv.EnumDictionar.PreturiStandard);
            this.mnuBtnPreturiClienti.Text = BMultiLingv.getElementById(BMultiLingv.EnumDictionar.PreturiClinici);
            this.mnuBtnEtape.Text = BMultiLingv.getElementById(BMultiLingv.EnumDictionar.Etape);
        }
        ...
        private void initControlListaEtape()
        {
            ...
            if (this.lctrlEtape == null)
            {
                this.lctrlEtape = new ControlListaEtape();
