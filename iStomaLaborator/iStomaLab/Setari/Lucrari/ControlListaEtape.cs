...
{
    public partial class ControlListaEtape : UserControlPersonalizat
    {
        ...
        private void DgvListaEtape_StergereLinie(DataGridViewPersonalizat pDGVSender, int pIndexRand)
        {
            ...
            try
            {
                ...
                if (etapaDeSters != null)
                {
                    ...
                    {
                        if (Mesaj.Confirmare(this.GetFormParinte(), BMultiLingv.getElementById(BMultiLingv.EnumDictionar.ConfirmatiReactivarea), etapaDeSters.Denumire))
                        {
                            etapaDeSters.Close(false, string.Empty, null);
                            ConstruiesteRanduriDGV();
                        }
                    }
                }
        ...
        private void ConstruiesteRanduriDGV(BColectieEtape pListaEtape)
        {
            this.dgvListaEtape.IncepeContructieRanduri();
            
            foreach (var elem in pListaEtape)
            {
            ...
            int totalEtape = pListaEtape.Count;
