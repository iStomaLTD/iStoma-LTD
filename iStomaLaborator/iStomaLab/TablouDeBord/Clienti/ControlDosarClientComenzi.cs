...
namespace iStomaLab.TablouDeBord.Clienti
{
    public partial class ControlDosarClientComenzi : UserControlPersonalizat
    {
        ...
        private void ConstruiesteColoaneDGVComenziTrecute()
        {
            ...
            this.dgvComenziTrecute.AdaugaColoanaData(EnumColoaneDGV.colDataFactura.ToString(), BMultiLingv.getElementById(BMultiLingv.EnumDictionar.DataEmiterii), 100, false, DataGridViewColumnSortMode.Automatic, CConstante.FORMAT_DATA);
