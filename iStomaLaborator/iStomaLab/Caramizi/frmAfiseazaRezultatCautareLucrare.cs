...
{
    public partial class frmAfiseazaRezultatCautareLucrare : Form
    {
        ...
        public frmAfiseazaRezultatCautareLucrare(string pDenumire)
        {
        ...
        public void Initializeaza(string pDenumire)
        {
            ...
            if (string.IsNullOrEmpty(pDenumire))
                ...
                this.lListaElementeGasite = BListaPreturiStandard.GetListaCautare(pDenumire, null);
