...
{
    public partial class frmAfiseazaRezultatCautareRegiune : Form
    {
        ...
        public frmAfiseazaRezultatCautareRegiune(int pIdTara, string pDenumire, bool pImpiedicaCrearea)
        {
        ...
        private void frmAfiseazaRezultatCautarePersoanaSauOrganizatie_Load(object sender, EventArgs e)
        {
            try
            {
                Initializeaza(this.lIdTara, this.lDenumire, this.lImpiedicaCrearea);
            }
            catch (Exception ex)
            {
