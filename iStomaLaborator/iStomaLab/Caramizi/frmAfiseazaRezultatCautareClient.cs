...
{
    public partial class frmAfiseazaRezultatCautareClient : Form
    {
        ...
        public frmAfiseazaRezultatCautareClient(string pDenumire)
        {
            ...
            this.Load += frmAfiseazaRezultatCautarePersoanaSauOrganizatie_Load;
            ...
            this.dgvLista.CellMouseClick += DgvLista_CellMouseClick;
        }
        ...
        public void Initializeaza(string pDenumire)
        {
            ...
            if (string.IsNullOrEmpty(pDenumire))
                ...
                this.lListaElementeGasite = BClienti.GetListaCautare(pDenumire, null);
        ...
        private void construiesteRanduri()
        {
            ...
            //NICIODATA NU VOM FACE ADAUGAREA DE AICI
