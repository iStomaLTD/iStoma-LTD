...
namespace iStomaLab.Caramizi
{
    ...
    public partial class ControlPerioada : UserControlPersonalizat
    {
        ...
        private void afiseazaPerioda()
        {
            ...
            {
                case CDefinitiiComune.EnumTipPerioada.Custom:
                    this.lblPerioadaAfisata.Text = string.Format("{0} {1} {2} - {3} {4} {5}",
                                                                        this.datInceput.DataAfisata.Day,
                                                                        CUtil.GetNumeLunaAnDin3Caractere(this.datInceput.DataAfisata.Month),
                                                                        this.datInceput.DataAfisata.Year,
                                                                        this.datSfarsit.DataAfisata.Day,
                                                                        CUtil.GetNumeLunaAnDin3Caractere(this.datSfarsit.DataAfisata.Month),
                                                                        this.datSfarsit.DataAfisata.Year);
                    break;
                case CDefinitiiComune.EnumTipPerioada.Luna:
                    ...
                    if (string.IsNullOrEmpty(IndicatieLuna))
                        ...
                        this.lblPerioadaAfisata.Text = string.Format("{0} {1} {2} - {3} {4} {5} ({6})",
                                                                        this.datInceput.DataAfisata.Day,
                                                                        CUtil.GetNumeLunaAnDin3Caractere(this.datInceput.DataAfisata.Month),
                                                                        this.datInceput.DataAfisata.Year,
                                                                        this.datSfarsit.DataAfisata.Day,
                ...
                case CDefinitiiComune.EnumTipPerioada.Saptamana:
                    ...
                    if (string.IsNullOrEmpty(IndicatieSaptamana))
                        this.lblPerioadaAfisata.Text = string.Format("{0} {1} {2} - {3} {4} {5}",
                                                                        ...
                                                                        CUtil.GetNumeLunaAnDin3Caractere(this.datInceput.DataAfisata.Month),
                                                                        this.datInceput.DataAfisata.Year,
                                                                        this.datSfarsit.DataAfisata.AddDays(-1).Day,
                                                                        CUtil.GetNumeLunaAnDin3Caractere(this.datSfarsit.DataAfisata.AddDays(-1).Month),
                                                                        this.datSfarsit.DataAfisata.AddDays(-1).Year);
                    else
                        this.lblPerioadaAfisata.Text = string.Format("{0} {1} {2} - {3} {4} {5} ({6})",
                                                                        this.datInceput.DataAfisata.Day,
                                                                        CUtil.GetNumeLunaAnDin3Caractere(this.datInceput.DataAfisata.Month),
