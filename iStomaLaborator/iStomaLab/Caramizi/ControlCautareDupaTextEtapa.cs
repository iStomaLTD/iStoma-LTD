...
{
    public partial class ControlCautareDupaTextEtapa : ControlCautareElement
    {
        ...
        public ControlCautareDupaTextEtapa()
        {
        ...
        private void BtnDeschide_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //BEtape etapa = FormListaEtape.Afiseaza(this.GetFormParinte());
                //if (etapa != null)
                //{
                //    this.Initializeaza(new StructIdDenumire(etapa.Id, BEtape.GetById(etapa.Id, null).Denumire), this.lTipDeschidere);
                //    ascundeEcranCautare();
                //    anuntaSelectia();
                //}
            }
        ...
        private void afiseazaCautare()
        {
            if (this.lEcranCautare == null)
            {
                this.lEcranCautare = new frmAfiseazaRezultatCautareLucrare(this.txtCautare.Text);
