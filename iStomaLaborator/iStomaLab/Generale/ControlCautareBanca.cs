...
{
    public partial class ControlCautareBanca : ControlCautareElement
    {
        ...
        private FormAfiseazaRezultatCautareBanca lEcranCautare = null;
        ...
        private void afiseazaCautare()
        {
            if (this.lEcranCautare == null)
            {
                this.lEcranCautare = new FormAfiseazaRezultatCautareBanca(this.txtCautare.Text);
