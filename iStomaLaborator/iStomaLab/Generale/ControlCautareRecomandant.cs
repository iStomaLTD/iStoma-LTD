...
{
    public partial class ControlCautareRecomandant : ControlCautareElement
    {
        ...
        private frmAfiseazaRezultatCautareRecomandant lEcranCautare = null;
        ...
        public int TipObiectAfisajCorespunzator { get { return this.lPersoanaSauOrganizatie.Tip; } }

        #endregion

        #region Constructor si Initializare

        public ControlCautareRecomandant()
        {
        ...
        private void afiseazaCautare()
        {
            if (this.lEcranCautare == null)
            {
                this.lEcranCautare = new frmAfiseazaRezultatCautareRecomandant(this.txtCautare.Text);
