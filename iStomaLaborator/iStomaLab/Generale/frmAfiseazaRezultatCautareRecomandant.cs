...
{
    public partial class frmAfiseazaRezultatCautareRecomandant : Form
    {
        ...
        public frmAfiseazaRezultatCautareRecomandant(string pDenumire)
        {
            ...
            this.dgvLista.CellClick += DgvLista_CellClick; // selectie cu mouse-ul ---lore
        ...
        private void construiesteRanduri()
        {
            ...
            //Nu permitem crearea de reprezentanti in iStoma
