...
namespace CCL.UI.TGV
{
    ...
    public class TreeGridNode : DataGridViewRow//, IComponent
    {
        ...
        public bool EsteExpandat { get { return this.IsExpanded; } }
        ...
        public void CollapseNode(TreeGridNode node)
        {
            if (node == null)
                node = this;
        ...
        public void ExpandNode(TreeGridNode node)
        {
            if (node == null)
                node = this;
        ...
        public C getListaObiecteNoduri<C, O>()
            where C : List<O>, new()
            where O : class
        {
            C listaRetur = new C();
            ...
            {
                if (node.Tag != null && node.Tag is O)
                {
                    listaRetur.Add(node.Tag as O);
                }
            }
            return listaRetur;
        }
