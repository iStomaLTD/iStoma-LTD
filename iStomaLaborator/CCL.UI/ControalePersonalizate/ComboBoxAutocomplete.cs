...
using EnumTipLista = CCL.UI.ComboBoxPersonalizat.EnumTipLista;

namespace CCL.UI.ControalePersonalizate
{
    public class ComboBoxAutocomplete : System.Windows.Forms.ComboBox,
        CCL.UI.IMembriComuniControalePersonalizate, IAllowModification
    {
        #region Declaratii Generale

        private System.ComponentModel.IContainer components = null;
        public event CCL.UI.ComboBoxPersonalizat.ZonaModificata CerereUpdate;
        ...
        public ComboBoxAutocomplete(IContainer container)
            : this()
        {
            container.Add(this);
        }
        ...
        protected override void OnValidated(EventArgs e)
        {
            ...
            try
            {
                if (this.CerereUpdate != null & ((!this._bInitByPropertyText) || (this._bRaiseEventLaModificareProgramatica)))
                {
