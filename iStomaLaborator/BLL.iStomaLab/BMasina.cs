...
{
    public sealed class BMasina
    {
        internal static BMasina statiaCurenta = null;
        ...
        public static string getDenumireMasina()
        {
