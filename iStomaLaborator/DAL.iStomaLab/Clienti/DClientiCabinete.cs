...
{
    public static class DClientiCabinete
    {

        #region Declaratii generale

        public const string NUME_TABELA = "ClientiCabinete_TD";
        public const string NUME_VIEW = "ClientiCabinete_TD";
        ...
        /// <summary>
        /// Recuperam o inregistrare din baza de date ClientiCabinete_TD
        /// </summary>
        ...
        /// <summary>
        /// Recuperam o lista de inregistrari din tabela ClientiCabinete_TD
        /// </summary>
        /// <remarks></remarks>
        ...
        /// <summary>
        /// Adaugam o noua inregistrare in tabela ClientiCabinete_TD
        /// </summary>
        ...
        /// <remarks></remarks>
        public static int Add(int pIdCreator, int pIdClient, string pDenumire, IDbTransaction pTranzactie)
        {
            BColectieCorespondenteColoaneValori dictCorespondenta = new BColectieCorespondenteColoaneValori();
            dictCorespondenta.Adauga(EnumCampuriTabela.xnIdClient.ToString(), pIdClient);
        ...
        /// <summary>
        /// Inchidem (dezactivam) o inregistrare din tabela ClientiCabinete_TD
        /// </summary>
        ...
        /// <summary>
        /// Modificam informatiile unei inregistrari din tabela ClientiCabinete_TD
        /// </summary>
