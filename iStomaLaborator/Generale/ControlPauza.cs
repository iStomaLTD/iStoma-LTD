...
namespace iStomaLab.Generale
{
    ...
    public partial class ControlPauza : UserControlPersonalizat
    {
        ...
        {
            if (BUtilizator.Conectare(BUtilizator.GetUtilizatorConectat().ContStoma, this.txtParolaPauza.Text, BStatiiDeLucruUtilizatori.GetPreferinteUtilizatorConectat(null).PastreazaConectat, null) != null)
                return true;
            return false;
        }
