...
{
    public partial class ControlCautareRegiune : ControlCautareElement
    {
        #region Declaratii generale

        public event System.EventHandler StergeObiectAfisaj;
        public event System.EventHandler SelecteazaObiectAfisaj;
        private frmAfiseazaRezultatCautareRegiune lEcranCautare = null;
        ...
        public int IdObiectAfisajCorespunzator
        {
            get
            {
                return this.lPersoanaSauOrganizatie.Id;
            }
        }
        ...
        void ControlCautarePersoanaSauOrganizatie_SizeChanged(object sender, EventArgs e)
        {
            try
            {
                this.Initializeaza(this.lIdTara, this.lPersoanaSauOrganizatie, this.lTipDeschidere);
            }
            catch (Exception ex)
            {
        ...
        private bool lImpiedicaCrearea = false;
        public void NuPermiteCrearea()
        {
            this.lImpiedicaCrearea = true;
        }

        public void Initializeaza(int pIdTaraInteres, StructIdDenumire pPersOrg, CCL.UI.CEnumerariComune.EnumTipDeschidere pTipDeschidere)
        {
            base.InitializeazaVariabileleGenerale();
            this.lPersoanaSauOrganizatie = pPersOrg;
            this.lTipDeschidere = pTipDeschidere;
            this.lIdTara = pIdTaraInteres;
        ...
        private void btnSterge_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lTextUltimaCautare = string.Empty;
                this.Initializeaza(this.lIdTara, StructIdDenumire.Empty, this.lTipDeschidere);
                anuntaStergerea();
            }
            catch (Exception ex)
            {
        ...
        private void afiseazaCautare()
        {
            if (this.lEcranCautare == null)
            {
                this.lEcranCautare = new frmAfiseazaRezultatCautareRegiune(this.lIdTara, this.txtCautare.Text, this.lImpiedicaCrearea);
                ...
                this.lEcranCautare.Initializeaza(this.lIdTara, this.txtCautare.Text, this.lImpiedicaCrearea);
        ...
        public void AllowModification(bool pPermiteModificarea)
        {
            ...
            this.txtCautare.AllowModification(this.lIdTara > 0 && this.lEcranInModificare);
        ...
        public void Goleste()
        {
            Initializeaza(this.lIdTara, StructIdDenumire.Empty, this.lTipDeschidere);
        }
