...
{
    public partial class frmAfiseazaRezultatCautareLocalitate : Form
    {
        ...
        public frmAfiseazaRezultatCautareLocalitate(int pIdRegiune, string pDenumire)
        {
        ...
        private void frmAfiseazaRezultatCautarePersoanaSauOrganizatie_Load(object sender, EventArgs e)
        {
            try
            {
                Initializeaza(this.lIdRegiune, this.lDenumire);
            }
            catch (Exception ex)
            {
