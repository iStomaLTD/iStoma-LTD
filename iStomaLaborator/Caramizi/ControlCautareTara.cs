...
{
    public partial class ControlCautareTara : ControlCautareElement
    {
        #region Declaratii generale

        public event System.EventHandler StergeObiectAfisaj;
        public event System.EventHandler SelecteazaObiectAfisaj;
        private frmAfiseazaRezultatCautareTara lEcranCautare = null;
        ...
        private void afiseazaCautare()
        {
            if (this.lEcranCautare == null)
            {
                this.lEcranCautare = new frmAfiseazaRezultatCautareTara(this.txtCautare.Text);
