...
namespace iStomaLab.Caramizi
{
    public partial class controlInchidere : Generale.UserControlPersonalizat
    {
        ...
        public void AllowModification(bool bPermiteModificarea)
        {
            ...
            this.btnDeschideListaMotiveInchidere.Visible = (this.lEcranInModificare && this.lDetaliiInchidere.ListaMotiveInchidere != CDefinitiiComune.EnumTipLista.Nedefinita);
